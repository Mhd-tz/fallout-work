...
that moment) and when the player presses **L** (ENTER on the prompt's button) at a site they drove to.
...
with the place's name and what it offers: `L` or the button hands off to the
game (§4). It is offered three ways - the prompt, `L`, and the route panel's
